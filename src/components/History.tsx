...
const History = () => {
  ...
  const videoHistory = [
    { id: 1, name: 'Segment 1', previewUrl: 'https://picsum.photos/200/100' },
    { id: 2, name: 'Segment 2', previewUrl: 'https://picsum.photos/200/100' },
    { id: 3, name: 'Segment 3', previewUrl: 'https://picsum.photos/200/100' },
  ];
